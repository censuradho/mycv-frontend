      ...
      <Styles.Container>
        ...
        <Container>
          ...
          as pessoas a construir e manter um perfil profissional online de qualidade e confiável.
            ...
            foram aconselhados a ler o conteúdo do acordo antes de prosseguir com o uso do serviço. Como usuário, o uso contínuo de www.mycv-online.vercel.app{' '} 
          ...
          <Styles.ContentView>
            ...
            <Typography as="p">
            O usuário está autorizado a usar os serviços do www.mycv-online.vercel.app apenas de acordo com os Termos{' '} 
            ...
            www.mycv-online.vercel.app ou outros membros deste serviço.
            </Typography>
            <br />
            <Typography as="p">
            O Usuário concorda que os serviços prestados pelo site não devem ser utilizados de forma negligente,{' '} 
            ...
            do www.mycv-online.vercel.app ou outros membros deste serviço.
            </Typography>
            <br />
            <Typography as="p">
            ...
            por escrito do www.mycv-online.vercel.app. Após a prestação dos serviços, o site pode publicar publicidade aos{' '} 
          ...
          <Styles.ContentView>
            ...
            <Typography as="p">
            Fornecer ao www.mycv-online.vercel.app seu endereço de e-mail autoriza o uso do site para{' '} 
            ...
            nossa Newsletter. O www.mycv-online.vercel.app pode fornecer outras notificações por e-mail, avisos, notificações{' '} 
            móveis via “push” ou por meio da publicação de informações no site www.mycv-online.vercel.app, conforme for necessário.{' '} 
            O www.mycv-online.vercel.app se reserva ao direito de determinar a forma e os meios de fornecer notificações aos usuários{' '} 
            registrados. O site não é responsável, no entanto, por qualquer filtragem automática que você ou seu provedor de{' '} 
            rede podem aplicar a notificações enviadas para o endereço de e-mail fornecido para www.mycv-online.vercel.app.
            </Typography>
          </Styles.ContentView>
          <Styles.ContentView>
            <Typography as="h2">Erros, correções e mudanças</Typography>
            <Typography as="p">
          O www.mycv-online.vercel.app não pode garantir que o Site esteja livre de erros ou de outros componentes prejudiciais, {' '} 
          nem que todos os defeitos serão corrigidos. Podemos fazer alterações nos recursos, funcionalidade ou conteúdo{' '} 
          do www.mycv-online.vercel.app a qualquer momento. Também nos reservamos o direito, a nosso critério exclusivo, de editar ou{' '} 
          ...
          <Styles.ContentView>
            ...
            um item ou qualquer conteúdo do site www.mycv-online.vercel.app viole qualquer direito de propriedade{' '} 
          ...
          <Styles.ContentView>
            ...
            <Typography as="p">
              O site www.mycv-online.vercel.app reserva-se o direito de investigar reclamações ou denúncias de violações deste Acordo. {' '}
          ...
          <Styles.ContentView>
            ...
            <Typography as="p">
            Links do www.mycv-online.vercel.app: O site www.mycv-online.vercel.app e os currículos do usuário podem conter links para outros sites.{' '} 
          ...
          <Styles.ContentView>
            ...
            o www.mycv-online.vercel.app não será responsabilizado por seu uso indevido ou não autorizado.
            </Typography>
            <Typography as="p">
            Links conteúdos em perfis de usuários no www.mycv-online.vercel.app que levam para outros sites estão além do controle deste serviço.
            </Typography>
            <Typography as="p">
            ...
            <Typography as="p">
              O www.mycv-online.vercel.app não será responsável por perda, lesão, reclamação, responsabilidade ou dano de qualquer{' '} 
            ...
            <ul>
              ...
              <li>o conteúdo encontrado no www.mycv-online.vercel.app, ou</li>
          ...
          <Styles.ContentView>
            ...
            <ul>
              <li>
              Copiar, distribuir ou divulgar qualquer parte do www.mycv-online.vercel.app em qualquer outro meio que inclua "coleta" automática ou não automática.
              </li>
              <li>
              Esses sistemas automatizados incluem, mas não estão limitados a “robôs”, “spiders” e{' '} 
              “leitores offline”, entre outros, para acessar www.mycv-online.vercel.app ou controlar os serviços deste site
              </li>
              <li>
              ...
              <li>
                ...
                transmissões de ou para os servidores em execução www.mycv-online.vercel.app
              </li>
              <li>
                Tomar medidas que possam impor, conforme determinado por www.mycv-online.vercel.app a nosso exclusivo critério,{' '} 
                uma carga irracional ou desproporcionalmente grande em nosso site.
              </li>
              <li>
                Envio de dados inválidos e ilegais, vírus, worms ou outros agentes de software por meio do www.mycv-online.vercel.app.
              </li>
              <li>
              Coletar ou colher quaisquer informações pessoais, como nomes de contas e e-mails de www.mycv-online.vercel.app.
              </li>
              <li>
              ...
              <li>
              Interferir no funcionamento adequado do www.mycv-online.vercel.app
              </li>
              <li>
              Acessando o conteúdo do site por meios não convencionais, exceto aqueles fornecidos ou autorizados por www.mycv-online.vercel.app
              </li>
              <li>
